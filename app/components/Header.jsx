          ...
          <div className="flex items-center justify-between w-full md:w-auto">
            <div className="flex items-center space-x-2">
              <Link href="/" className="flex items-center space-x-2 group">
                ...
                <Badge variant="secondary" className="bg-blue-200 font-bold text-blue-700">
                  AI
                </Badge>
              </Link>
            </div>
          ...
          <div className="flex-1 max-w-2xl mx-0 md:mx-8 order-2 md:order-none w-full">
            <div className="relative">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-3 gap-2 z-10">
                ...
                <Button size="sm" className="rounded-full bg-blue-600 hover:bg-blue-700 shadow-md">
                  <Brain className={`h-4 w-4 ${aiMode ? 'animate-spin-slow' : ''}`} />
                </Button>
              </div>
